;
; Velleman K8048 PIC16F676 ICSPIO Demo Test (Receive commands, send data).
;
...
; RA4 AN3 !T1G OSC2 CLKOUT 3    12 RA1 AN1 CIN- VREF ICSPCLK
; RA3 !MCLR VPP            4    11 RA2 AN2 T0CKI INT COUT
; RC5                      5    10 RC0 AN4
; RC4                      6     9 RC1 AN5
; RC3 AN7                  7-----8 RC2 AN6
;
...
;*****************************************************************************
;
; K8048 PIC16F676 ICSPIO Demo Test (Receive commands, send data).
;
